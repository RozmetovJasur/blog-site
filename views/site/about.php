...
$this->title = t("Sayt haqida");
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-about">
    <h1>Sayt haqida</h1>

    <p>Sizni bizning true.uz web-saytimizda ko'rishdan xursandmiz!</p>

    <p style="text-align: center"><img style="width: 50%;" src="/uploads/img/lang.jpg" alt=""></p>

    <p>
        Nima uchun sayt nomi true? Chunki asosiy dasturiy ta'minotlar kompyuter uchun yoziladi.Komputerda dasturlarning
        bajarilishi oxirgi bosqichda true yoki false(1 yoki 0) ga borib taqaladi.Bu web-saytda siz barcha sohadagi dasturiy ta'minotlardan habardor
        bo'lishingiz mumkin.
        Bizning asosiy yo'nalishimiz web-saytlarni ishlab chiqishdir. Bu yerda
        web-saytni ishlab chiqishni qayerdan boshlashni, chiroyli web-saytni qanday yaratishni,sayt uchun serverni qanday qilib
        to'g'ri sozlash kerakligini bilib olishingiz mumkin.PHP,Python,JAVA va C# dasturlash tillarida dastur tuzishni va berilganlar
        bazasi (SQL) bilan ishlashni o'rganishingiz mumkin.
    </p>
    ...
    <p>Bizning <a href="https://github.com/RozmetovJasur/blog-site">loyihamiz</a> ochik kodli(opensource).</p>
</div>