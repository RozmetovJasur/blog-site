...
return [
    ...
    '{attribute} cannot be blank.' => 'Поле обязательно для заполнения.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => 'Поля должен содержать не менее {min, number} {min, plural, one{символ} few{символа} many{символов} other{символа}}.',
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => 'Поля должен содержать максимум {max, number} {max, plural, one{символ} few{символа} many{символов} other{символа}}.',
